...
@Component({
  selector: 'app-reminders-birthday-list',
  templateUrl: './reminders-birthday-list.component.html',
  styleUrls: ['./reminders-birthday-list.component.scss']
})
export class RemindersBirthdayListComponent implements OnInit {
  ...
  updateReminder(person: IPerson) {
    this.remindersService.update(`${environment.BASE_URL}/api/reminders/updatepersonbirthdaylastvisit/${person.Id}`, {})
      .subscribe(() => {
